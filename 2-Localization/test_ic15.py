...
def test(args):
    ...
    if args.arch == "resnet50":
        ...
        model = models.resCAnet50(pretrained=True, num_classes=7, scale=args.scale)
    elif args.arch == "resCAnet101":
        model = models.resCAnet101(pretrained=True, num_classes=7, scale=args.scale)
    elif args.arch == "resCAnet152":
        model = models.resCAnet152(pretrained=True, num_classes=7, scale=args.scale)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--resume', nargs='?', type=str, default='./model/checkpoint.pth.tar',
