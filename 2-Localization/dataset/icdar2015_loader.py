...
ic15_root_dir = './data/zj/icdar2015/'
ic15_train_data_dir = ic15_root_dir + 'train/train_image/'
ic15_train_gt_dir = ic15_root_dir + 'train/train_label/'
ic15_test_data_dir = ic15_root_dir + 'test/test_image/'
ic15_test_gt_dir = ic15_root_dir + 'test/test_label/'
...
#                 bboxes.append(box)
#             except:
#                 print('load label failed on {}'.format(gt_path))
#             # tags.append(True)
#     return np.array(bboxes), tags
