...
class FPA(nn.Module):
    ...
    def __init__(self,inplanes,planes=512):
        ...
        self.bn_gpb = nn.InstanceNorm2d(inplanes)
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=4, scale=1, recurrence=2):
        self.inplanes = 64
        self.scale = scale
        ...
        # self.conv2 = nn.Conv2d(14,14,kernel_size=1,stride=1)
        # self.bn2 = nn.BatchNorm2d(14)

        self.conv2 = nn.Conv2d(8,8,kernel_size=1,stride=1)
        ...
        # self.conv4 = nn.Conv2d(14, num_classes, kernel_size=1, stride=1, padding=0)

        self.conv4 = nn.Conv2d(8, num_classes, kernel_size=1, stride=1, padding=0)
    ...
    def forward(self, x):
        ...
        # print(p2.shape)=[1,256,158,158]
        x_dsn = self.dsn(p2)
        # print(x_dsn.shape)=[1,7,158,158]
        #print(x.shape)
        x1 = self.head(p2, self.recurrence)
        # print(x.shape)=[1,7,158,158]
        outs = torch.cat([x1, x_dsn],1)
        ...
        # print(out.shape)=[1,7,640,640]
        return out    
		
def resCAnet50(pretrained=False, **kwargs):
