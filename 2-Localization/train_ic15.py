...
def main(args):
    if args.checkpoint == '':
        args.checkpoint = "checkpoints/SGD_ic15_%s_bs_%d_ep_%d"%(args.arch, args.batch_size, args.n_epoch)
    if args.pretrain:
...
if __name__ == '__main__':
    ...
    parser.add_argument('--lr', nargs='?', type=float, default=1e-3,
                        help='Learning Rate')
    parser.add_argument('--resume', nargs='?', type=str, default='checkpoints/SGD_ic15_resCAnet50_bs_2_ep_500/checkpoint.pth.tar',
